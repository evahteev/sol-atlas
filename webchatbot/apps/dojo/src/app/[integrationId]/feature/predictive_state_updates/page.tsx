...
const DocumentEditor = () => {
  ...
  }, [agentState?.document, currentDocument, editor, nodeName]);
  ...
  }, [agentState?.document, currentDocument, editor, isLoading]);
