...
export const ProfileBarI18n: FC<ProfileBarProps> = ({ className, chains }) => {
  const t = useTranslations('ProfileBar')
    ...
    <>
      <div className={clsx(styles.container, className)} id="profile-bar">
        <div className={styles.personal}>
          ...
          <Dropdown caption={t('joinUs')} className={styles.joinus} placement="bottom-end">
                ...
                {socials?.NEXT_PUBLIC_SOCIAL_TELEGRAM && (
                  <li className={styles.item}>
                    <Link
                      ...
                      <span className={styles.caption}>{t('telegram')}</span>
                ...
                {socials?.NEXT_PUBLIC_SOCIAL_X && (
                  <li className={styles.item}>
                    <Link
                      ...
                      <span className={styles.caption}>{t('twitter')}</span>
                      <IconExternal className={styles.indicator} />
                    </Link>
                  </li>
                )}
                {socials?.NEXT_PUBLIC_SOCIAL_DISCORD && (
                  <li className={styles.item}>
                    <Link
                      ...
                      <span className={styles.caption}>{t('discord')}</span>
                      <IconExternal className={styles.indicator} />
                    </Link>
                  </li>
                )}
                {socials?.NEXT_PUBLIC_SOCIAL_YOUTUBE && (
                  <li className={styles.item}>
                    <Link
                      ...
                      <span className={styles.caption}>{t('youtube')}</span>
                      <IconExternal className={styles.indicator} />
                    </Link>
                  </li>
                )}
