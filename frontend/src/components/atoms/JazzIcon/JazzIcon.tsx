...
type JazzIconProps = SVGAttributes<SVGSVGElement> & {
  size?: number
  seed?: number
  className?: string
}
...
const JazzIcon: FC<JazzIconProps> = ({ size = 100, seed, className, ...rest }) => {
  ...
  return (
    <svg
      ...
      className={className}
      {...rest}>
      <rect x="0" y="0" rx="0" ry="0" height={size} width={size} fill={genColor(remainingColors)} />
