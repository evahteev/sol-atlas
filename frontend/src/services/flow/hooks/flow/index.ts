...
export const useFlows = ({
  ...
  initialData?: components['schemas']['FlowRest'][]
  filter?: string
  limit?: number
  offset?: number
} = {}) => {
  return useQuery({
    ...
    queryKey: ['FlowClientObject.flows.list', { filter, limit, offset }],
    queryFn: () => FlowClientObject.flows.list({ filter, limit, offset }),
  })
}
...
export const useFlow = ({
  ...
  id: string
  query?: Partial<UseQueryParameters<Awaited<ReturnType<typeof FlowClientObject.flows.get>> | null>>
}) => {
  return useQuery({
    ...query,
    queryKey: ['FlowClientObject.flows.list', { id }],
    queryFn: () => FlowClientObject.flows.get(id),
  })
}
