...
from warehouse_api.db.dependencies import get_db_session
from warehouse_api.db.utils import create_database, drop_database
from warehouse_api.services.rabbit.dependencies import get_rmq_channel_pool
from warehouse_api.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from warehouse_api.services.redis.dependency import get_redis_pool
from warehouse_api.settings import settings
from warehouse_api.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from warehouse_api.db.meta import meta  # noqa: WPS433
    from warehouse_api.db.models import load_all_models  # noqa: WPS433
