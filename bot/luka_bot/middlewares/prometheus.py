"""
Prometheus middleware for aiohttp web application.
Tracks HTTP requests, responses, and processing times.
"""
...
def prometheus_middleware_factory(
    ...
    """Create Prometheus middleware for tracking HTTP requests and responses."""
