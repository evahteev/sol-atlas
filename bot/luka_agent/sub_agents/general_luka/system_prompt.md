...
→ knowledge_base(query="crypto portfolio", date_from="30d")
...
→ support(topic="knowledge_base_search")
...
6. **Specialized Agents**:
   ...
   - Use sub_agent tool to check what's available
