...
class TestSubAgentToolExecution:
    ...
    @pytest.mark.asyncio
    @patch('luka_agent.tools.sub_agent.context_service.get_workflow_context_service')
    ...
    @pytest.mark.asyncio
    @patch('luka_agent.tools.sub_agent.orchestration_service.get_workflow_service')
    @patch('luka_agent.tools.sub_agent.discovery_service.get_workflow_discovery_service')
