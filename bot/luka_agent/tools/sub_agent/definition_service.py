...
from luka_agent.tools.sub_agent.workflow_definition import WorkflowDefinitionSchema, StepType
from luka_agent.core.loader import redis_client
...
class WorkflowDefinitionService:
    ...
    async def _validate_tool_compatibility(
        ...
        # In the future, we can import a local tool registry here if needed.
        available_tools = []
            ...
            warnings.append(
                {
                    ...
                    "domain": domain,
                    "suggestion": "Break down large workflows into smaller sub-agents",
                }
            )
